...
#define SUBSCRIBER_EXTN_DATA_TOPIC \
  "/jimmbot_controller/jimmbot_extn_data_controller/extn_data"
...
class HilWheelCommander {
 public:
  ...
  void esp32NodeFeedbackCallback(
  ...
  inline const double getMaxSpeed(void) const { return this->_max_speed; }
